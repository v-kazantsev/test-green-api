...
export const ChatContentView = () => (
  <VStack className="chat-content-view">
    ...
    <ChatMessageView type="outcoming" message="Outcoming Message Outcoming Message Outcoming Message Outcoming Message Outcoming Message Outcoming Message Outcoming Message" />
    <ChatMessageView type="incoming" message="Incoming Message" />
